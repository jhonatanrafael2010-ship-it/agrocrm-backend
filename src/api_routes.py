...
bp.register_blueprint(routing_bp)
...
# WhatsApp/Telegram endpoints → MIGRADO para routes/messaging.py
...
def is_stale_clients_request(text: str) -> bool:
    ...
    triggers = [
        ...
        "clientes a mais tempo sem visita",
        "clientes á mais tempo sem visita",
        ...
        "quais clientes estão mais atrasados em visitas",
        "quais clientes estao mais atrasados em visitas",
...
# ================================================================
# MIGRADO para routes/admin.py:
# - /insights/<consultant_id>
# - /cron/daily-reminders
# - /cron/test-reminder/<consultant_id>
# - /admin/diseases
...
# Endpoints removidos - ver routes/admin.py
